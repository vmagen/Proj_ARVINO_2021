...
namespace webAPI.Controllers
{
    ...
    public class WineController : ApiController
    {
        ...
        /// <summary>
        ///  https://localhost:44370/api/Wine?CategoryId=2
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <summary>
        /// https://localhost:44370/api/Wine/GetWineCategory?id=1
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        [Route("api/Wine/GetWineCategory")]
        public IHttpActionResult GetWineCategory(int id)
        {
            try
            {
                return Ok(WineCategoryModel.GetCategory(id, db));
            }
            catch (Exception ex)
            {
                return Content(HttpStatusCode.BadRequest, ex);
