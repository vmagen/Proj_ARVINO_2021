...
namespace webAPI.Controllers
{
    ...
    public class RateController : ApiController
    {
        ...
        /// <summary>
        /// https://localhost:44370/api/Rate/GetWineryComment?Id=1
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        [Route("api/Rate/GetWineryComment")]
        public IHttpActionResult GetWineryComment(int Id)
        {
            try
            {
                return Ok(RateModel.comment(Id, db));
            }
            catch (Exception ex)
            {
                return Content(HttpStatusCode.BadRequest, ex);
