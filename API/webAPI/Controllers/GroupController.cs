            ...
            try
            {
                ...
                if (u == null)
                {
                    if (!string.IsNullOrEmpty(value.groupName)
                        && (!string.IsNullOrEmpty(value.groupDescription)
                            && (!string.IsNullOrEmpty(value.ImgPath)
                                && (!string.IsNullOrEmpty(value.creatorEmail)))))
                    {
                ...
                {
                    return Content(HttpStatusCode.BadRequest, " קהילה קיימת במערכת");
                }
            }
            catch (Exception ex)
            {
