...
namespace DATA.EF
{
    ...
    public partial class ArvinoDbContext : DbContext
    {
        ...
        public virtual DbSet<RV_ServiceCategory> RV_ServiceCategory { get; set; }
        public virtual DbSet<RV_Service> RV_Service { get; set; }
        public virtual DbSet<RV_ArticelPictures> RV_ArticelPictures { get; set; }
        public virtual DbSet<RV_articles> RV_articles { get; set; }
